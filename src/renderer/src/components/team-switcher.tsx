      ...
      <SidebarMenuItem>
        <DropdownMenu>
          ...
          >
            ...
            {teams.map((team) => {
              ...
              return (
                <DropdownMenuItem
                  ...
                  className="gap-3 px-3 py-2.5 rounded-lg cursor-pointer hover:bg-gray-100 focus:bg-gray-100 transition-colors"
                >
            ...
            {/* Add workspace */}
            <DropdownMenuItem className="gap-3 px-3 py-2.5 rounded-lg cursor-pointer hover:bg-gray-100 focus:bg-gray-100 transition-colors">
            ...
            {/* Sign out */}
            <DropdownMenuItem className="gap-3 px-3 py-2.5 rounded-lg cursor-pointer hover:bg-red-50 focus:bg-red-50 transition-colors">
              <div className="flex size-7 items-center justify-center">
