...
import { X, ExternalLink, FileText, Bold, Italic, Underline, Strikethrough, Link, Image } from 'lucide-react'
                ...
                {note && (
                    <>
                        ...
                        <div className="px-4 py-2 border-t border-border shrink-0 flex items-center justify-between">
                            <div className="flex items-center gap-1">
                                <ToolbarButton title="Bold"><Bold className="size-3.5" /></ToolbarButton>
                                <ToolbarButton title="Italic"><Italic className="size-3.5" /></ToolbarButton>
                                <ToolbarButton title="Underline"><Underline className="size-3.5" /></ToolbarButton>
                                <ToolbarButton title="Strikethrough"><Strikethrough className="size-3.5" /></ToolbarButton>
                                <span className="w-px h-4 bg-border mx-1" />
                                <ToolbarButton title="Link"><Link className="size-3.5" /></ToolbarButton>
                                <ToolbarButton title="Image"><Image className="size-3.5" /></ToolbarButton>
                            </div>
                            <div className="flex items-center gap-1">
