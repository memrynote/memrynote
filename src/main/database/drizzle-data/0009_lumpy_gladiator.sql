...
INSERT INTO `__new_sync_devices`("id", "name", "platform", "os_version", "app_version", "linked_at", "last_sync_at", "is_current_device") SELECT "id", "name", "platform", "os_version", "app_version", "linked_at", "last_sync_at", "is_current_device" FROM `sync_devices`;--> statement-breakpoint
